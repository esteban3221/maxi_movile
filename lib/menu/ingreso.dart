...
class _IngresoPageState extends State<IngresoPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Botón Enviar
          ElevatedButton.icon(
            onPressed: () => _enviarIngreso(context),
  ...
  void _enviarIngreso(BuildContext context) async {
    ...
    AsyncHttpService.consumeAndDo<Map<String, dynamic>>(
      ...
      onSuccess: (Map<String, dynamic> data) {
        setState(() {
          _mensaje =
              '✅ Ingreso registrado con éxito! ID: ${data['id'] ?? 'N/A'}';
        });
        ...
        _mostrarDetallesIngreso(context, data);
      },
  ...
  void _mostrarDetallesIngreso(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Ingreso Registrada'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Detalles de la ingreso:'),
